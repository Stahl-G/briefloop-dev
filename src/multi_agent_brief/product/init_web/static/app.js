...
(function () {
    ...
    var MESSAGES = {
        zh: {
            ...
            note_search_topic: "填写一个简短、明确的行业或主题；Human 明确填写的值就是唯一 Tavily 检索词。公司 / 组织名称、任务说明和报告类型都不会改写它。",
            sec_audience: "谁会读它？",
        ...
        en: {
            ...
            note_search_topic: "Enter one concise, explicit industry or topic. The Human-entered value is the sole Tavily query; company / organization, task objective, and report type do not rewrite it.",
